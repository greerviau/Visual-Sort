...
public class VisualSorting {
	...
	public void initialize() {
		//SET UP FRAME
		jf = new JFrame();
		jf.setIconImage(Toolkit.getDefaultToolkit().getImage(VisualSorting.class.getResource("/image/icon.png")));
		jf.setSize(800,635);
